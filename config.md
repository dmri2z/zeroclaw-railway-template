...
| `skills` | Skills loading | no | open-skills disabled (untrusted third-party repo) |
...
| `skills.open_skills_enabled` | `false` | Disabled — third-party repo (`besoeasy/open-skills`) not trusted |
